...
class DialogFragmentRemoteDetail extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		email = (TextView) v.findViewById(R.id.detail_email);
		...
		pickuptime = (TextView) v.findViewById(R.id.detail_pickuptime);
		phone = (TextView) v.findViewById(R.id.detail_phone);
	...
	public void onStart() {
		...
		name.setText(mOrder.get(mPosition).getName());
		email.setText(mOrder.get(mPosition).getUserEmail());
		...
		pickuptime.setText(mOrder.get(mPosition).getPickUptime());
		phone.setText(mOrder.get(mPosition).getPhone());
